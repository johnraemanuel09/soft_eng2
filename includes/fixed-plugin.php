...
<li class="list-group-item border-0 d-flex align-items-center px-0 mb-2 pt-0">
<div class="avatar me-3">
<a href="" target="_blank"><img src="../../assets/img/rodnelrianzares.png" alt="kal" class="border-radius-lg shadow" ></a>
</div>
<div class="d-flex align-items-start flex-column justify-content-center">
<a href="https://github.com/rodzpogi" target="_blank"><h6 class="mb-0 text-sm">Rodnel M. Rianzares</h6></a>
<p class="mb-0 text-xs">Assistant Programmer</p>
</div>
